      ...
      <div className="map-stats">
        ...
        >
          ...
          <div className="stats-bottom">
            ...
            <h6>
              {panelRegion.confirmed > 0 && !isNaN(panelRegion.active)
                ? '(' +
                  ((panelRegion.active / panelRegion.confirmed) * 100).toFixed(
                    2
                  ) +
                  '%)'
                : ''}
        ...
        >
          ...
          <div className="stats-bottom">
            ...
            <h6>
              {panelRegion.confirmed > 0 && !isNaN(panelRegion.recovered)
                ? '(' +
                  (
                    (panelRegion.recovered / panelRegion.confirmed) *
                    100
                  ).toFixed(2) +
                  '%)'
                : ''}
        ...
        >
          ...
          <div className="stats-bottom">
            ...
            <h6>
              {panelRegion.confirmed > 0 && !isNaN(panelRegion.deaths)
                ? '(' +
                  ((panelRegion.deaths / panelRegion.confirmed) * 100).toFixed(
                    2
                  ) +
                  '%)'
                : ''}
