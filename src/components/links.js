  ...
  return (
    <div className="Links">
      ...
      <div className="link fadeInUp" style={{animationDelay: '0.3s'}}>
        <h3>To find a testing centre near your place</h3>
        <a href="https://covid.icmr.org.in/index.php/testing-facilities">https://covid.icmr.org.in/index.php/testing-facilities</a>
      </div>
