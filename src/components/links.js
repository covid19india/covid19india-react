  ...
  return (
    <div className="Links">
      ...
      <div className="link fadeInUp" style={{animationDelay: '0.3s'}}>
        ...
        <a href="https://www.mohfw.gov.in/" target="_blank" >https://www.mohfw.gov.in/</a>
      </div>
      ...
      <div className="link fadeInUp" style={{animationDelay: '0.5s'}}>
        <h3>CDC</h3>
        <a href="https://www.cdc.gov/coronavirus/2019-ncov/faq.html" target="_blank">
      ...
      <div className="link fadeInUp" style={{animationDelay: '0.6s'}}>
        ...
        <a href="https://coronavirus.thebaselab.com/" target="_blank">
