...
const getFormattedLink = (initialValue) => {
  ...
  const s2 = s1.replace(
    reinsta,
    '<a href="https://www.instagram.com/$1" target="_blank" rel="noopener noreferrer">Instagram: @$1</a>'
  );
  const s3 = s2.replace(
    refb,
    '<a href="https://www.facebook.com/$1" target="_blank" rel="noopener noreferrer">Facebook: @$1</a>'
  );
  return (
    <div
